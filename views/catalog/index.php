        ...
        <div class="main-products_inner">
            ...
            <div class="catalog container">
                ...
                <div class="catalog-container">
                    ...
                    <!--                    <button class="main-filter_dropdown-a" href="">Фильтр</button>-->
                    <!--                    <div class="main-filter_dropdown">-->
                    <!--                        <a href="">Цена</a>-->
                    <!--                    </div>-->
                    <!--                </div>-->
                    <!--                <div class="main-sort_dropdown filter_sort_and_category-dropdown-div">-->
                    <!--                    <button class="main-sort_dropdown-a" href="">Сортировка</button>-->
                    <!--                </div>-->
                    <!--                <div class="main-category_dropdown filter_sort_and_category-dropdown-div">-->
                    <!--                    <button class="main-category_dropdown-a" href="">Категория</button>-->
                    <!--                </div>-->
                    <!--            </div>-->
                            ...
                            <div class="container">
                                <ul>
                                    <?php foreach ($errors as $error): ?>
                                        <li class="warranty_card-subtitle_span"><?php echo $error; ?></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                        <?php endif; ?>
